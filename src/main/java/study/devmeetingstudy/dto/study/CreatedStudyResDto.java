...
public class CreatedStudyResDto {
    ...
    public static CreatedStudyResDto of(Study study, StudyFile studyFile) {
        if (Study.isInstanceOnline(study)) {
            return CreatedOnlineStudyResDto.of((Online) study, studyFile);
        }
        return CreatedOfflineStudyResDto.of((Offline) study, studyFile);
    }
